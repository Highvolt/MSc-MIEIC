...
\begin{itemize}
\item The \textbf{Demand Side Platform (DSP)}\index{DSP} is a tool used by the advertisers to act on their behalf on the \emph{RTB}. \emph{DSPs}\index{DSP} allows them to set
...
\begin{figure}[h]
  ...
  \end{center}
\end{figure}
\footnotetext{ \url{http://www.ibm.com/developerworks/library/os-weka1/weka-startup1.jpg}}
