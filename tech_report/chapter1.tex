...
The objective of this thesis is to develop a library capable of generating future access logs using only past data from the same network. The generated access log
must have the same attributes as the original dataset.
